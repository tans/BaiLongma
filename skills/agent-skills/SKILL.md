---
name: Agent Skills
description: Explain, inspect, create, and maintain LiloAvatar Agent Skills packages built around SKILL.md instructions.
tags:
  - skills
  - agent
  - workflow
...
Use this skill when the user asks about LiloAvatar skills, wants to list installed skills, or wants to create a reusable workflow package.

## LiloAvatar Skill Format

A LiloAvatar Agent Skill is a folder under the configured skills root. The required file is `SKILL.md`.
...
- Keep `description` specific. LiloAvatar uses it during skill selection.
