---
name: Agent Skills
description: Explain, inspect, create, and maintain GeekAgent Agent Skills packages built around SKILL.md instructions.
tags:
  - skills
  - agent
  - workflow
...
Use this skill when the user asks about GeekAgent skills, wants to list installed skills, or wants to create a reusable workflow package.

## GeekAgent Skill Format

A GeekAgent Agent Skill is a folder under the configured skills root. The required file is `SKILL.md`.
...
- Keep `description` specific. GeekAgent uses it during skill selection.
