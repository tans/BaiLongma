...

{
  ...
  const previousReader = globalThis.getLiloAvatarWindowLayoutSnapshot
  globalThis.getLiloAvatarWindowLayoutSnapshot = () => ({
    displays: [],
    windows: [
      {
  ...
  globalThis.getLiloAvatarWindowLayoutSnapshot = () => ({ displays: [], windows: [] })
  assert.match(formatTerminalStreamContext(), /visible_window: no/)
  if (previousReader) {
    globalThis.getLiloAvatarWindowLayoutSnapshot = previousReader
  } else {
    delete globalThis.getLiloAvatarWindowLayoutSnapshot
  }
}
