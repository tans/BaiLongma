...
const ROLE_RULES = [
  {
    ...
    keywords: [/geekagent|bailongma/i, /agent/i, /llm/i, /prompt/i, /context/i, /memory/i, /codex/i, /claude/i, /openai/i, /minimax/i],
...
function inferProjects(text) {
  const projects = []
  if (/geekagent|bailongma/i.test(text) || /GeekAgent|白龙马/.test(text)) projects.push('GeekAgent')
