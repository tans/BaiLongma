      ...
      parameters: {
        ...
        properties: {
          ...
          topic: {
            ...
            description: 'Required when action=open. Choose one topic: voice_asr, voice_tts, voice_config, model_config, wechat_config, self_architecture (how LiloAvatar works internally), or ui_design (LiloAvatar\'s interface / Scene UI design). Do not invent other values. Optional when action=close.'
          },
      ...
      parameters: {
        ...
        properties: {
          ...
          placement: {
            ...
            description: 'Optional window placement. Default auto avoids the main LiloAvatar window when possible; call status first if you need exact screen/window bounds.'
          },
          bounds: {
            type: 'object',
            properties: {
