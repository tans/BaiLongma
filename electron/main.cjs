...
global.getLiloAvatarWindowLayoutSnapshot = getLiloAvatarWindowLayoutSnapshot
...
// 第一步只检测+写日志(USER_DIR/logs/wake-word.log),命中"LiloAvatar"不做其他动作。
...
function getLiloAvatarWindowLayoutSnapshot() {
  const { screen } = require('electron')
